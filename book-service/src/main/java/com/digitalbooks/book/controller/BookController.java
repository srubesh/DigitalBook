...
public class BookController {
	...
	// public ResponseEntity<?> saveBook(@RequestParam("image") MultipartFile file,
	// @RequestBody Book book, @PathVariable("author-id") int authorId) {
	...
	public ResponseEntity<?> updateBook(@RequestParam("image") MultipartFile file,
			@PathVariable("author-id") int authorId, @PathVariable("book-id") Long bookId, @ModelAttribute Book book) {
	...
	@PostMapping("author/{author-id}/books/{book-id}/{block}")
	...
	*/
	...
	public ResponseEntity<?> searchBook(@RequestParam String category, @RequestParam String title,@RequestParam String author,
			@RequestParam String price, @RequestParam String publisher){
		Optional<List<Book>> bookList = bookService.searchBook(category,title,Integer.valueOf(author),Double.valueOf(price),publisher);
